...
public class BoardController {
	...
	public String write(BoardDTO dto) {
		...
		//인터페이스의 메타정보를 넘겨받는다 (BoardDAO.class) : 역컴파일 (정보만 받는다)	
		//1. 패키지위치와 매퍼의 네임 스페이스가 같고
		//2. id이름과 메소드명이 같다면 동기화
	...
	public String list(Model model, String pg) {
		...
		//Mybatis >> DTO >> resultType="kr.or.mycom.model.BoardDTO"
		//10건의 데이터 DTO 10개 만들고 list 만들고 거기에 add하고 그 주소를 return ArrayList add
