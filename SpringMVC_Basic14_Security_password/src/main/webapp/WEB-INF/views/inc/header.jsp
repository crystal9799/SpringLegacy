...
<div id="header">
	<div class="top-wrapper">
		...
		<ul id="loginmenu" class="block_hlist">
			...
			1. 회원가입 시 모든 회원은 default로 ROLE_USER 권한
			-->
			<se:authorize access="!hasRole('ROLE_USER')"><!-- 인증되지 않았다면(로그인 하지 않았다면) -->
				<li><a href="${pageContext.request.contextPath}/joinus/login.htm">로그인</a></li>
			</se:authorize>
			...
			<!-- 이때 name은 내부적으로 userPrincipal 객체의 속성을 가져오는데, 자동으로 userid/username 같은 속성의 값을 가져온다.-->
			
			<!-- Any -> OR  ROLE_USER 또는 ROLE_ADMIN 이라면 -->
		...
		<ul id="membermenu" class="clear">
			<li><a href="${pageContext.request.contextPath}/joinus/memberconfirm.htm">
